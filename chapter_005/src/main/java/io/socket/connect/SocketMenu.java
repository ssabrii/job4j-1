...
import io.socket.assembly.Assembling;
import io.socket.assembly.Assembly;
import io.socket.source.StorageServer;
...
public class SocketMenu {
     ...
     * @param out out line
     */
    public final void out(final String out) {
        this.assembly.outLine(out);
    }
